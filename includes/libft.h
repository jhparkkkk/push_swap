...
/*   Updated: 2022/02/12 14:39:09 by jeepark          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_lstdelone_int(t_list_int *lst, void (*del)(void*));
void		ft_lstclear_int(t_list_int **lst, void (*del)(void*));
void 		lstprint(t_list_int *list);
